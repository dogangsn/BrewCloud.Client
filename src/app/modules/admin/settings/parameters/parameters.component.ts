...
export class ParametersComponent implements OnInit {
  ...
  getParametersList() {
    this._parametersService.getparameterList()
  ...
  fillFormData(getparam: parametersListDto[]) {
    ...
    if (this.getParameters !== null) {
        this.parameters.setValue({
          id : getparam[0].id,
          appointmentReminderDuration: getparam[0].appointmentReminderDuration,
          ...
          isOtoCustomerWelcomeMessage: getparam[0].isOtoCustomerWelcomeMessage,
...
filterCustomerId(value: any): void {
  ...
  saveParameter() {
    ...
    const parameterItem = new UpdateParametersCommand(
      ...
      this.getFormValueByName('smsCompany') !== "" ? this.getFormValueByName('smsCompany') : "00000000-0000-0000-0000-000000000000" ,
      this.getFormValueByName('cashAccount') !== "" ? this.getFormValueByName('cashAccount') : "00000000-0000-0000-0000-000000000000",
      this.getFormValueByName('creditCardCashAccount') !== "" ? this.getFormValueByName('creditCardCashAccount') :  "00000000-0000-0000-0000-000000000000",
      this.getFormValueByName('bankTransferCashAccount') !== "" ? this.getFormValueByName('bankTransferCashAccount') : "00000000-0000-0000-0000-000000000000",
      this.getFormValueByName('whatsappTemplate') !== "" ? this.getFormValueByName('whatsappTemplate') : "00000000-0000-0000-0000-000000000000",
      this.getFormValueByName('customerWelcomeTemplate') !== "" ? this.getFormValueByName('customerWelcomeTemplate') : "00000000-0000-0000-0000-000000000000",
